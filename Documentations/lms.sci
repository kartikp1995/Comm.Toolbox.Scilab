...
//This function creates an AdaptiveAlgorithm Object for a Least Mean Square Algorithm to use it with `lineareq` or `dfe` to create an equalizer object.
...
//Kartik Patel
    ...
    alg = struct('AlgType', 'LMS', 'StepSize', stepsize, 'LeakageFactor', leakage_factor);
