...
//This function creates an AdaptiveAlgorithm Object for a signed Least Mean Square Algorithm to use it with `lineareq` or `dfe` to create an equalizer object.
...
//alg_type:Select algorithm from a set of signed LMS algortihms. Options: 'Sign LMS' (default), 'Signed Regressor LMS', 'Sign Sign LMS'
